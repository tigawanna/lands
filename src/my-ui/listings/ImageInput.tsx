...
import { ImagePlusIcon, PanelRightClose, X } from "lucide-react";
import { ListingFormInputs } from "@/state/pb/api/listings";
  ...
  return (
    <div className="w-full  h-full flex flex-col items-center justify-center ">
            ...
            {oldPics.map((file: string, index) => {
              ...
              return (
                ...
                >
                  ...
                  /> */}
                  <X className="h-5 w-5" onClick={() => clearImage(index)} />
                  {img_url &&<Image
                   alt="propery preview"
                    height={100}
                    width={100}
      ...
      <div className="w-[90%]">
        ...
        /> */}
        <ImagePlusIcon className="h-8 w-8" onClick={() => fileInput.current?.click()}/>
      </div>
    </div>
  );
};
